 ...
 * @author 23.01425-3
 */
public class TelaRegras2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        telaLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/telRegras2Imagem.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRegras2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRegras2().setVisible(true);
            }
        });
    }
